...
export default function LaunchPage() {
  ...
  return (
    <div className="relative w-screen min-h-screen overflow-x-hidden flex flex-col" style={{ background: "#000" }}>
      ...
      {/* ─── LinkedIn link — bottom left corner ─── */}
      <motion.a
        href="https://www.linkedin.com/company/moodwave-cli/"
        target="_blank"
        rel="noopener noreferrer"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 2 }}
        className="fixed bottom-5 left-5 z-50 flex items-center gap-2 px-3 py-2 rounded-lg transition-colors hover:bg-white/[0.05]"
      ...
      >
        ...
        <span className="font-mono text-[10px] text-white/30">LinkedIn</span>
      </motion.a>
